...
def parse_input(file: str) -> tuple:
...
def validate_ordering(orders: list, page: list, part_one: bool = False) -> int:
...
def part1(input_file: str) -> str:
    ...
    ordering, pages = parse_input(input_file)
    return str(sum(validate_ordering(ordering, page, part_one=True) for page in pages))


def part2(input_file: str) -> str:
    """Returns the solution for part 2 of the day."""
    ordering, pages = parse_input(input_file)
    return str(sum(validate_ordering(ordering, page, part_one=False) for page in pages))
